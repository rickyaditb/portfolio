...
{#key isInView}
    {#key lang}
        <h1 in:fly={Configuration['animation']['in-fly']} class="font-bold text-4xl">
            {Translation[lang].education}
        </h1>
    {/key}
    <div in:fly={Configuration['animation']['in-fly']} class="p-3 lg:flex gap-5 items-center">
        ...
        <img
            src="assets/img/education.png"
            class="w-36 h-36 hidden lg:block"
            alt="University Icon"
        />
